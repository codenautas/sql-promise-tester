...
sqlPromiseTester = function(motor, opts){
    ...
    describe('sql-promise-tester '+motor.motorName, function(){
        ...
        describe('connectected tests', function(done){
            ...
            describe('fetchUniqueRow()', function(done) {
                it('must fail if multiple data is received',function(done){
                    var cursor=conn.query(
                        "SELECT * FROM example1"
                ...
                it('must fail if multiple data when called with no rows',function(done){
                    var cursor=conn.query(
            ...
            describe('fetchUniqueValue()', function(done) {
                it('must fail if multiple data is received',function(done){
                    var cursor=conn.query(
                        "SELECT * FROM example1"
