...
sqlPromiseTester = function(motor, opts){
    ...
    describe('sql-promise-tester '+motor.motorName, function(){
        ...
        describe('connectected tests', function(done){
            ...
            testLimitedFetch('fetchUniqueRow', {datum: 'three'}, true, done);
            testLimitedFetch('fetchUniqueValue', 'three', true, done);
            testLimitedFetch('fetchOneRowIfExists', {datum: 'three'}, false, done);
        });
    });
};
